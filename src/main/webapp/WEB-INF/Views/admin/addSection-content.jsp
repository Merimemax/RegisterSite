...
<form:form  modelAttribute="newSection" method="POST" action="/section/add/${blockid}" class="form-horizontal" role="form" >
   ...
   <div style="text-align: center;">
		<form:errors path="sectionNo" cssStyle="color : red;" />
	</div>
    </div>
  </div> <!-- form-group // -->
